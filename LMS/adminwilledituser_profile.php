    ...
    <script>
        $(document).ready(function() 
        {
            ...
            $('#genrate').click(function (){
                ...
                var ran2 = Math.floor(Math.random() * 100000);
                var ran3 = Math.floor(Math.random() * 100000000 + 5);
                var regis_gen = ran1 + "/" + ran2 + "/" + ran3;
                document.getElementById("value1").value = regis_gen;
            })
                ...
                <table>
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="text" name="registrationnumber" id="value1" value="<?php echo $registrationnumber;?>" placeholder="Registration Number" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <label for="registrationfee">Registration Fee</label>
                            <input type="text" name="registrationfee" value="<?php echo $registrationfee;?>" placeholder="Registration fee">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <label for="licence">licence number</label>
                            <input type="text" name="licence_number" id="value2"  value="<?php echo $licence_number?>" placeholder="licence number" readonly>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="licenceissueddate">Licence Issue Date</label>
                            <input type="date" name="licenceissueddate" value="<?php echo $licenceissueddate;?>" placeholder="Licence Issue Date">
                        </td>
                        <td>
                            <label for="licencevalidupto">Licence Valid Up To</label>
                            <input type="date" name="licencevalidupto" id="value4" value="<?php echo $licencevalidupto; ?>" >
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                           <a href="#" id="genrate" style="color:white">Click to Genrate</a>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="stampingplace">Stamping Place
                                <h5>Office/Online</h5>
                            </label>
                            <input type="text" name="stamppingplace" value="<?php echo $stamppingplace; ?>" placeholder="Stamping palce">
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="applicationstatus" value="<?php echo $applicationstatus; ?>" >
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="text" name="aadhaarnumber" placeholder="Aadhaar Number" value="<?php echo $aadhaarnumber; ?>">
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
                   ...
                   <!-- ============================================================================================  -->
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <input type="text" name="salarystatus" placeholder="Salary Status" value="<?php echo $salarystatus; ?>" >
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label for="salarydate">Salary Date</label>
                            <input type="date" name="salarydate" value="<?php echo $salarydate; ?>" >
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
